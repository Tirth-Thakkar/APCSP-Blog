...
<span class="nb">print</span><span class="p">(</span><span class="sa">f</span><span class="s1">&#39;This is the result of binary division of the values 1101 and 1010: </span><span class="si">{</span><span class="n">division</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span><span class="si">}</span><span class="s1"> and the remainder is </span><span class="si">{</span><span class="n">division</span><span class="p">[</span><span class="mi">1</span><span class="p">]</span><span class="si">}</span><span class="s1">&#39;</span><span class="p">)</span>
</pre></div>
